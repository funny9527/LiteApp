    ...
    BridgeBatch: {
         ...
         Login: {
               ...
               onLoad: function (options) {
                   return '<view class="container"><view class="usermotto"height="800px" width="800px" color="#00ffff"></view><button bindtap="bindViewTap" height="140px" width="240px" >下一页</button></view>'
               },
         ...
         Show: {
               ...
               onLoad: function (options) {
                   return '<view class="container"><view class="usermotto"height="800px" width="800px" color="#3300ffff"></view><button bindtap="bindViewTap" height="140px" width="240px" >上一页</button></view>'
               },
